    ...
    <div class="container-fluid content">
        ...
        <div class="col-md-8 col-xs-12 col-sm-12 menu-right">
            <div class="text main">
                ...
                <a class="tablink" onclick="openPage('all', this, 'black')">All</a>
...
?>
            ...
            <div id="searched" class="text sub add-margin add-spacing tabcontent" style="display: block;">The objectives of the organisation are,
